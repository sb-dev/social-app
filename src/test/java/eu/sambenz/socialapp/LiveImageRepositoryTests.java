...
public class LiveImageRepositoryTests implements ImageRepositoryTest {
    @Autowired
    ...
    public void testFindAll() {
        Flux<Image> images = this.repository.findAll();
    ...
    public void testFindByName() {
        Mono<Image> image = this.repository.findByName("test-image-3.jpg");
